...
return [
    'ddos' => [
        ...
        'per_ip_per_minute' => (int) env('WINGS_DDOS_PER_IP_PER_MINUTE', 180),
        'per_ip_burst' => (int) env('WINGS_DDOS_PER_IP_BURST', 40),
        'global_per_minute' => (int) env('WINGS_DDOS_GLOBAL_PER_MINUTE', 1800),
        'global_burst' => (int) env('WINGS_DDOS_GLOBAL_BURST', 180),
        'strike_threshold' => (int) env('WINGS_DDOS_STRIKE_THRESHOLD', 8),
        'block_seconds' => (int) env('WINGS_DDOS_BLOCK_SECONDS', 900),
