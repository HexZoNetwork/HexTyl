...
const RightNavigation = styled.div`
    ...
    & > button,
    & > .navigation-link {
        ${tw`flex items-center h-full no-underline text-neutral-300 px-4 sm:px-5 cursor-pointer transition-all duration-150`};
        ...
        &:hover {
            ...
            border-left-color: rgba(141, 185, 207, 0.18);
            border-right-color: rgba(141, 185, 207, 0.18);
        }
